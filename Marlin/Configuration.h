 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 -1 //default: undefined //serial lcd port
...
#define DEFAULT_TRAVEL_ACCELERATION   2000  //default: 1000 // X, Y, Z acceleration for travel (non printing) moves
